...
namespace NStudio.Renderers.Office2007
{
    /// <summary>
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private readonly static Blend _statusStripBlend;
        #endregion

        #region Static Colors
        private readonly static Color _c1 = Color.FromArgb(167, 167, 167);
        private readonly static Color _c2 = Color.FromArgb(21, 66, 139);
        //private readonly static Color _c3 = Color.FromArgb(76, 83, 92);
        private readonly static Color _c4 = Color.FromArgb(250, 250, 250);
        private readonly static Color _c5 = Color.FromArgb(248, 248, 248);
        private readonly static Color _c6 = Color.FromArgb(243, 243, 243);
        private readonly static Color _r1 = Color.FromArgb(255, 255, 251);
        private readonly static Color _r2 = Color.FromArgb(255, 249, 227);
        private readonly static Color _r3 = Color.FromArgb(255, 242, 201);
        private readonly static Color _r4 = Color.FromArgb(255, 248, 181);
        private readonly static Color _r5 = Color.FromArgb(255, 252, 229);
        private readonly static Color _r6 = Color.FromArgb(255, 235, 166);
        private readonly static Color _r7 = Color.FromArgb(255, 213, 103);
        private readonly static Color _r8 = Color.FromArgb(255, 228, 145);
        private readonly static Color _r9 = Color.FromArgb(160, 188, 228);
        private readonly static Color _rA = Color.FromArgb(121, 153, 194);
        //private readonly static Color _rB = Color.FromArgb(182, 190, 192);
        //private readonly static Color _rC = Color.FromArgb(155, 163, 167);
        private readonly static Color _rD = Color.FromArgb(233, 168, 97);
        private readonly static Color _rE = Color.FromArgb(247, 164, 39);
        private readonly static Color _rF = Color.FromArgb(246, 156, 24);
        private readonly static Color _rG = Color.FromArgb(253, 173, 17);
        private readonly static Color _rH = Color.FromArgb(254, 185, 108);
        private readonly static Color _rI = Color.FromArgb(253, 164, 97);
        private readonly static Color _rJ = Color.FromArgb(252, 143, 61);
        private readonly static Color _rK = Color.FromArgb(255, 208, 134);
        private readonly static Color _rL = Color.FromArgb(249, 192, 103);
        private readonly static Color _rM = Color.FromArgb(250, 195, 93);
        private readonly static Color _rN = Color.FromArgb(248, 190, 81);
        private readonly static Color _rO = Color.FromArgb(255, 208, 49);
        private readonly static Color _rP = Color.FromArgb(254, 214, 168);
        private readonly static Color _rQ = Color.FromArgb(252, 180, 100);
        private readonly static Color _rR = Color.FromArgb(252, 161, 54);
        private readonly static Color _rS = Color.FromArgb(254, 238, 170);
        private readonly static Color _rT = Color.FromArgb(249, 202, 113);
        private readonly static Color _rU = Color.FromArgb(250, 205, 103);
        private readonly static Color _rV = Color.FromArgb(248, 200, 91);
        private readonly static Color _rW = Color.FromArgb(255, 218, 59);
        private readonly static Color _rX = Color.FromArgb(254, 185, 108);
        private readonly static Color _rY = Color.FromArgb(252, 161, 54);
        private readonly static Color _rZ = Color.FromArgb(254, 238, 170);

        // Color scheme values
        private readonly static Color _textDisabled = _c1;
        private readonly static Color _textMenuStripItem = _c2;
        private readonly static Color _textStatusStripItem = _c2;
        private readonly static Color _textContextMenuItem = _c2;
        private readonly static Color _arrowDisabled = _c1;
        private readonly static Color _arrowLight = Color.FromArgb(106, 126, 197);
        private readonly static Color _arrowDark = Color.FromArgb(64, 70, 90);
        private readonly static Color _separatorMenuLight = Color.FromArgb(245, 245, 245);
        private readonly static Color _separatorMenuDark = Color.FromArgb(197, 197, 197);
        private readonly static Color _contextMenuBack = _c4;
        private readonly static Color _contextCheckBorder = Color.FromArgb(242, 149, 54);
        private readonly static Color _contextCheckTick = Color.FromArgb(66, 75, 138);
        private readonly static Color _statusStripBorderDark = Color.FromArgb(86, 125, 176);
        private readonly static Color _statusStripBorderLight = Color.White;
        private readonly static Color _gripDark = Color.FromArgb(114, 152, 204);
        private readonly static Color _gripLight = _c5;
        private readonly static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
        private readonly static GradientItemColors _itemDisabledColors = new GradientItemColors(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6, Color.FromArgb(224, 224, 224), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210), Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195));
        private readonly static GradientItemColors _itemToolItemSelectedColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, _r9, _rA);
        private readonly static GradientItemColors _itemToolItemPressedColors = new GradientItemColors(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
        private readonly static GradientItemColors _itemToolItemCheckedColors = new GradientItemColors(_rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
        private readonly static GradientItemColors _itemToolItemCheckPressColors = new GradientItemColors(_rT, _rU, _rV, _rW, _rX, _rI, _rY, _rZ, _r9, _rA);
        #endregion
        ...
        private static void RenderToolButtonBackground(Graphics g,
        ...
        private static void DrawGradientToolItem(Graphics g, 
                                          ToolStripItem item, 
        ...
        private static void DrawGradientToolSplitItem(Graphics g,
                                               ToolStripSplitButton splitButton, 
        ...
        private static void DrawGradientContextMenuItem(Graphics g,
                                                 ToolStripItem item,
                                                 GradientItemColors colors)
        {
            // Do we need to draw with separator on the opposite edge?
        ...
        private static void DrawGripGlyph(Graphics g, 
                                   int x, 
                                   int y, 
                                   Brush darkBrush, 
                                   Brush lightBrush)
        ...
        private static void DrawSeparator(Graphics g,
                                   bool vertical,
                                   Rectangle rect,
                                   Pen lightPen,
                                   Pen darkPen,
